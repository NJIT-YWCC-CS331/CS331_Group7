...
<div id="wrapper">
            ...
            <nav>
                <ul>
                    <?php if ($is_staff_logged_in): ?>
                        ...
                        <li>
                            <a href="AdminView.php?action=logout" class="button small" style="margin-left: 10px;">
                                Logout
                            </a>
                        </li>
                    <?php else: ?>
    ...
    <div id="main">
        <div class="inner">
            ...
            <a href="AdminReservations.php" class="button primary" style="margin-bottom: 20px; display: inline-block;">
                View Reservations
            </a>
